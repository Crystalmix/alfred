    ...
    "quickConnectParse", "$timeout", function(quickConnectParse, $timeout) {
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          checkQuery = function() {
            if (scope.query) {
              scope.scope.is_interrupt_arrow_commands = true;
            } else {
              scope.scope.is_interrupt_arrow_commands = false;
            }
            return scope.$apply();
          };
