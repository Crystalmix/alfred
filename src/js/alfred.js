    ...
    "quickConnectParse", "$timeout", function(quickConnectParse, $timeout) {
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          if (!angular.isDefined(attrs.onRemoveHostCallback)) {
            scope.onRemoveHostCallback = function(connection) {
