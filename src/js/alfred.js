    ...
    "quickConnectParse", "$timeout", "constant", function(quickConnectParse, $timeout, constant) {
      return {
        ...
        controller: function($scope, $element) {
          var collections_to_update, filter_hosts_by_chosen_tags, getConnections, getGroups, initChosenFlagsToTags, parseConnect, transformationData;
          $scope.query = null;
          $scope.chosen_tags = [];
