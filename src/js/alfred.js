...
angular.module('alfredDirective').run(['$templateCache', function ($templateCache) {
	$templateCache.put('src/templates/alfred.html', '<div id="{{uid}}" class="alfred-widget" ng-click="setFocusAtInput()"> <div class="alfred"> <md-toolbar> <div class="tollbar-container"> <md-input-container class="alfred-input"> <label>{{placeholder}}</label> <input type="text" class="form-control input-lg input" ng-model="query" ng-keydown="keydown($event)"/> </md-input-container> <!--id="alfred-input"--> <!--ng-model="query"--> <!--placeholder="{{placeholder}}"/>--> <md-button class="history-menu"> <i class="mdi mdi-menu" ng-click="changeActiveList()"></i> </md-button> <div ng-if="isLeftActive" class="head-groups"> <div class="parent-group"> <ul> <li> ALL HOSTS </li> <li ng-repeat="group in groups" class="parent-group-list"> {{group.label}} </li> </ul> </div> <div class="tags"> <ul> <li ng-repeat="tag in tags"> <md-button><i class="mdi mdi-tag"></i> {{tag.label}}</md-button> </li> </ul> </div> </div> <div ng-if="isLeftActive" class="bottom-group"> <div class="children-group"> <ul> <li ng-repeat="group in childgroups"> <md-button>{{group.label}}</md-button> </li> </ul> </div> <div class="add-new-group"> <md-button>+</md-button> </div> </div> </div> </md-toolbar> <md-content class="shadow-box"> <div ng-if="connections.length || histories.length"> <div ng-if="isTable" class="table"> <div id="left" ng-class="{ active: isLeftActive }" ng-if="isLeftActive"> <!--<span>Hosts</span>--> <!--class="add glyphicon glyphicon-plus"></span></a>--> <!--<a type="button"><span class="glyphicon glyphicon-arrow-left"></span></a>--> <!--</div>--> <div class="left-list" ng-if="isLeftActive"> <active-list connections="connections" amount="amount" height-cell="heightCell" query="query" from="fromConnection" selected-index="selectedIndex" rest="restOfConnections" cmd-system-hotkey="cmdSystemHotkey"> </active-list> </div> <div class="left-list" ng-if="isRightActive"> <inactive-list connections="connections" amount="amount" height-cell="heightCell" from="fromConnection" rest="restOfConnections"> </inactive-list> </div> </div> <div id="right" ng-class="{ active: isRightActive }" ng-if="isRightActive"> <!--<span>History</span>--> <!--<a type="button"><span class="glyphicon glyphicon-arrow-right"></span></a>--> <!--</div>--> <div class="left-list" ng-if="isLeftActive"> <inactive-list connections="histories" amount="amount" height-cell="heightCell" from="fromHistory" rest="restOfHistories"> </inactive-list> </div> <div class="left-list" ng-if="isRightActive"> <active-list connections="histories" amount="amount" height-cell="heightCell" query="query" from="fromHistory" selected-index="selectedIndex" rest="restOfHistories" cmd-system-hotkey="cmdSystemHotkey"> </active-list> </div> </div> </div> <div ng-if="!isTable"> <div class="main-list"> <active-list connections="entities" amount="amount" height-cell="heightCell" query="query" from="fromConnection" selected-index="selectedIndex" cmd-system-hotkey="cmdSystemHotkey"> </active-list> </div> </div> </div> </md-content> </div> </div> ');
